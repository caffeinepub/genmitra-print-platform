...
import { ShoppingCart, Star, Truck, Shield, RotateCcw, ChevronLeft, Zap } from 'lucide-react';
...
export default function ProductDetailPage() {
  ...
  if (!product) {
    return (
      <div style={{ backgroundColor: '#f5f6f7' }} className="min-h-screen flex items-center justify-center">
    ...
    <div style={{ backgroundColor: '#f5f6f7' }} className="min-h-screen">
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
          ...
          <span>/</span>
          <button
            onClick={() => navigate({ to: '/', search: { category: product.category, search: undefined } })}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-5">
            <div className="bg-white rounded-lg shadow-card border border-gray-100 p-5">
              <p className="text-sm text-[#2874f0] font-medium mb-1">{product.category}</p>
              ...
              <div className="flex items-baseline gap-2 mb-4">
                ...
                <span className="text-sm text-green-600 font-semibold">17% off</span>
              </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full py-3 bg-[#2874f0] text-white font-bold rounded hover:bg-[#1f5bb8] transition-colors flex items-center justify-center gap-2 text-base"
              >
