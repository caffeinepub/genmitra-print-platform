...
export default function HeroBanner() {
  ...
  return (
    <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #1a237e 0%, #2874f0 50%, #42a5f5 100%)' }}>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-blue-100 text-lg mb-8 max-w-md">
              Transform your favorite photos into stunning prints, frames, mugs, and more. Professional quality delivered to your door.
            </p>
