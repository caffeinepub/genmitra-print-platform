          ...
          <div className="bg-white rounded-lg shadow-card p-12">
            ...
            <button
              ...
              onClick={() =>
                navigate({
                  to: "/login",
                  search: { mode: undefined, redirect: "/my-orders" },
                })
              }
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="space-y-4">
          {orderList.map((order) => {
            ...
            const imgSrc = firstItem
              ? getImageSrc(
                  firstItem.customImageData || firstItem.product.imageData,
                )
              : null;
            ...
            return (
              <button
                key={order.orderId}
                type="button"
                className="bg-white rounded-lg shadow-card border border-gray-100 overflow-hidden hover:shadow-card-hover transition-shadow cursor-pointer w-full text-left"
                onClick={() =>
                  navigate({
                    to: "/order/$orderId",
